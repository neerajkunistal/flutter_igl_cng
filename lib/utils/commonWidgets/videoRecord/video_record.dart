...
class VideoRecord extends StatefulWidget {
  ...
  @override
  State<VideoRecord> createState() {
    return _VideoRecordState();
  }
}
...
class _VideoRecordState extends State<VideoRecord>
  ...
  void initState() {
    ...
    for (final CameraDescription cameraDescription in camerasList) {
  ...
  void onStopButtonPressed() {
    ...
    stopVideoRecording().then((XFile? file) {
      ...
      if (file != null) {
        ...
        videoFile = file;
        print("Video recorded to :  ${videoFile!.path.toString()}");
        // _startVideoPlayer();
      }
    });
  }
