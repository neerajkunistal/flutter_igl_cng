...
class ViewEquipmentWidget extends StatelessWidget {
                  ...
                  return RefreshIndicator(
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                            child: _listBuilder(dataState: state, context: context)
                        ),
                      ],
                    ),
                  );
  ...
  Widget _tabWidget({required FetchViewEquipmentComplaintDataState dataState, required BuildContext context}) {
      ...
      child: ListView(
        ...
        children: [
                          ...
                          shape:
                              WidgetStateProperty.all<RoundedRectangleBorder>(
                                  RoundedRectangleBorder(
                                      ...
                                      side: BorderSide(
                                          color: EnvironmentConfig.of(context)!
                                              .primaryTheme))))
                      : null,
                  onPressed: () {
          ...
          userData.roleType == RoleType.stationUser || userData.roleType == RoleType.stationUserManager
              ...
              : const SizedBox.shrink(),
          userData.roleType == RoleType.shiftEngineer || userData.roleType == RoleType.mi
              ? TextButton(
                ...
                return GestureDetector(
                    onTap: () async {
                      ...
                      if (dataState.reviewComplaintList[index].complaintStatus.toString() == "1") {
                        ...
                        BlocProvider.of<ReviewComplaintBloc>(context).add(ReviewComplaintPageLoadEvent(context: context, reviewComplaintData: dataState.reviewComplaintList[index]));
                        BlocProvider.of<AddSparePartBloc>(context).add(AddSparePartPageLoadEvent(context: context));
                        var result = await Navigator.push(context, FadeRoute(page: const ReviewComaplintPage()));
                        ...
                        if (result.toString() == "Completed") {
                          ...
                          dataState.reviewComplaintList[index].complaintStatus.toString() == "0" &&
                          dataState.reviewComplaintList[index].ackStatus.toString() != "0" &&
                          dataState.reviewComplaintList[index].assignType.toString() == "1") {
                        ...
                        if (result.toString() == "Completed") {
                          ...
                          dataState.reviewComplaintList[index].complaintStatus.toString() == "0" &&
                          dataState.reviewComplaintList[index].miAssignType.toString() == "3") {
                        BlocProvider.of<AddSparePartBloc>(context)
                            .add(AddSparePartClearSparePartEvent());
                        BlocProvider.of<ReviewComplaintBloc>(context).add(
                            ReviewComplaintPageLoadEvent(
                      ...
                      } else if (userLogin.roleType == RoleType.mi && dataState.reviewComplaintList[index].action.toString() != "3" && dataState.reviewComplaintList[index].complaintStatus.toString() != "1") {
                        BlocProvider.of<AddSparePartBloc>(context)
                            .add(AddSparePartPageLoadEvent(context: context));
