...
class ViewEquipmentWidget extends StatelessWidget {
  ...
  const ViewEquipmentWidget({super.key, required this.equipmentComplaintType});
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                    onTap: () async {
                      ...
                      if (dataState.reviewComplaintList[index].complaintStatus.toString() ==
                          "1") {
                        return;
                        ...
                        if (result.toString() == "Completed") {
                          BlocProvider.of<ViewEquipmentComplaintBloc>(
                           ...
                           || userLogin.roleType == RoleType.it) &&
                          dataState.reviewComplaintList[index].assignType.toString() ==
                              "3") {
                        BlocProvider.of<AddSparePartBloc>(context)
                            .add(AddSparePartClearSparePartEvent());
                      ...
                      } else if ((userLogin.roleType == RoleType.shiftEngineer || userLogin.roleType == RoleType.it) &&
                          dataState.reviewComplaintList[index].miAssignType.toString() ==
                              "3") {
                        BlocProvider.of<AddSparePartBloc>(context)
                            .add(AddSparePartClearSparePartEvent());
                      ...
                      } else if ((userLogin.roleType == RoleType.shiftEngineer || userLogin.roleType == RoleType.it) && dataState.selectedTabIndex == 5 ||
                      ...
                      } else if ((userLogin.roleType == RoleType.shiftEngineer || userLogin.roleType == RoleType.stationUser || userLogin.roleType == RoleType.it) &&
