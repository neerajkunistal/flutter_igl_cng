...
class _AddEquipmentComplaintPageState extends State<AddEquipmentComplaintPage> {
  ...
  void initState() {
    BlocProvider.of<AddEquipmentComplaintBloc>(context).add(
        AddEquipmentComplaintPageLoadEvent(context: context));
    super.initState();
  }
  ...
  Widget _complaintDropDown({required FetchAddEquipmentComplaintState dataState}) {
    return DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddEquipmentComplaintBloc>(context).add(
            AddEquipmentComplaintSelectComplaintDataEvent(complaintTypeData: value));
      },
  ...
  Widget _equipmentDropDown({required FetchAddEquipmentComplaintState dataState}) {
    return DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddEquipmentComplaintBloc>(context).add(
            AddEquipmentComplaintSelectEquipmentDataEvent(equipmentTypeData: value));
      },
          ...
          child: Column(
            children: [
              TextButton(onPressed: () {
                BlocProvider.of<AddEquipmentComplaintBloc>(context).add(AddEquipmentComplaintAddImageEvent(context: context, mediaType: 1));
              }, child: TextWidget("Camera", fontSize: AppFont.font_16,)),
              const Divider(),
              TextButton(onPressed: () {
                BlocProvider.of<AddEquipmentComplaintBloc>(context).add(AddEquipmentComplaintAddImageEvent(context: context, mediaType: 2));
  ...
  Widget _button({required FetchAddEquipmentComplaintState dataState}) {
    ...
    ButtonWidget(text: AppString.submit,
        ...
        onPressed: () {
          BlocProvider.of<AddEquipmentComplaintBloc>(context).add(AddEquipmentComplaintSubmitEvent(context: context));
        }
