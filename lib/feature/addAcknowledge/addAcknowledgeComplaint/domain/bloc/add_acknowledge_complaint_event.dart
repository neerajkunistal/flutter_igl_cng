...
class AddAcknowledgeComplaintPageLoadEvent
...
class AddAcknowledgeComplaintSelectComplaintDataEvent
    extends AddAcknowledgeComplaintEvent {
  final ComplaintTypeModel complaintTypeData;

  const AddAcknowledgeComplaintSelectComplaintDataEvent(
...
class AddAcknowledgeComplaintSelectEquipmentDataEvent
    extends AddAcknowledgeComplaintEvent {
  final EquipmentTypeModel equipmentTypeData;

  const AddAcknowledgeComplaintSelectEquipmentDataEvent(
...
class AddAcknowledgeComplaintSelectComplaintEvent
    extends AddAcknowledgeComplaintEvent {
  final ComplaintModel complaintData;

  const AddAcknowledgeComplaintSelectComplaintEvent(
...
class AddAcknowledgeComplaintSelectReviewComplaintEvent
    extends AddAcknowledgeComplaintEvent {
  final ReviewComplaintModel reviewComplaintData;

  const AddAcknowledgeComplaintSelectReviewComplaintEvent(
...
class AddAcknowledgeComplaintSelectDepartmentEvent
    extends AddAcknowledgeComplaintEvent {
  final DepartmentModel departmentData;

  const AddAcknowledgeComplaintSelectDepartmentEvent(
...
class AddAcknowledgeComplaintSelectUserEvent
  ...
  const AddAcknowledgeComplaintSelectUserEvent(
...
class AddAcknowledgeComplaintSelectAcknowledgeComplaintEvent
    extends AddAcknowledgeComplaintEvent {
  final AcknowledgeModel acknowledgeData;

  const AddAcknowledgeComplaintSelectAcknowledgeComplaintEvent(
...
class AddAcknowledgeComplaintSelectBreakDownEvent
    extends AddAcknowledgeComplaintEvent {
...
class AddAcknowledgeComplaintAddImageEvent
    extends AddAcknowledgeComplaintEvent {
  final BuildContext context;
  final int mediaType;

  const AddAcknowledgeComplaintAddImageEvent(
...
class AddAcknowledgeComplaintSelectTimeData
    extends AddAcknowledgeComplaintEvent {
  final BuildContext context;
...
class AddAcknowledgeComplaintSelectDateData
    extends AddAcknowledgeComplaintEvent {
  final BuildContext context;
...
class AddAcknowledgeComplaintSelectStatusData
    extends AddAcknowledgeComplaintEvent {
  final String complaintStatus;

  const AddAcknowledgeComplaintSelectStatusData(
...
class AddAcknowledgeComplaintSelectGeneralDataEvent
    extends AddAcknowledgeComplaintEvent {
  final GeneralComplaintModel generalComplaintData;

  const AddAcknowledgeComplaintSelectGeneralDataEvent(
