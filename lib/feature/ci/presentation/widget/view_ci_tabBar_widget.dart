...
class ViewCiTabBarWidget extends StatelessWidget {
  ...
  const ViewCiTabBarWidget({super.key, required this.dataState});
  ...
  Widget _tabWidget({required FetchViewCiComplaintDataState dataState,
            ...
            child: TextButton(
                ...
                onPressed: () {
                  BlocProvider.of<ViewCiComplaintBloc>(context).add(
                      const ViewCiComplaintSelectTabDataEvent(
                          tabIndex: 0));
                },
                child: TextWidget(
