...
class StartRouteWidget extends StatelessWidget {
  final int index;
  final BuildContext mContext;

  const StartRouteWidget(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _scmQuantityTextField(context: context, dataState: dataState),
              SizedBox(
                height: MediaQuery.of(context).size.height * 0.01,
              ),
              Row(
              ...
              _slipPhoto(context: context, dataState: dataState),
              SizedBox(
  ...
  Widget _slipPhoto(
    ...
    return SizedBox(
      ...
      child: InkWell(
        onTap: () {
          BlocProvider.of<RequestBloc>(context)
              .add(RequestUploadPhotoEvent(photoIndex: 3, context: context));
        },
        child: DottedBorder(
          color: AppColor.grey,
          strokeWidth: 1,
          child: dataState.uploadSlipImage.path.isEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
