...
class ViewCvUpdateStatusWidget extends StatelessWidget {
  ...
  Widget _amountController({required FetchViewCvComplaintDataState dataState,
    required BuildContext context}) {
  ...
  Widget _photo(
      {required FetchViewCvComplaintDataState dataState, required BuildContext context}) {
    return SizedBox(
              ...
              TextButton(
                  onPressed: () {
                    BlocProvider.of<ViewCvComplaintBloc>(context).add(
                        ViewCvComplaintSelectFileEvent(
      ...
      child: ButtonWidget(
          ...
          onPressed: () {
            BlocProvider.of<ViewCvComplaintBloc>(context)
                .add(ViewCvComplaintSubmitEvent(context: context, cngData: cngData));
          }),
