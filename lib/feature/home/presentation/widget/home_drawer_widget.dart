...
/*            userData.roleType == RoleType.shiftEngineer
  ...
  Widget _acknowledge({required BuildContext context}) {
    return Padding(
      padding:  EdgeInsets.only(top: MediaQuery.of(context).size.width * 0.02,
          bottom:  MediaQuery.of(context).size.width * 0.02),
      child: GestureDetector(
        ...
        child: Row(
          children: [
            Icon(Icons.account_tree_outlined, color: AppColor.black,),
            SizedBox(
              width: MediaQuery.of(context).size.width * 0.03,
            ),
            TextWidget(AppString.acknowledge,
              fontSize: AppFont.font_12,
            ),
          ],
        ),
  ...
  Widget _reviewComplaint({required BuildContext context}) {
    return Padding(
      padding:  EdgeInsets.only(top: MediaQuery.of(context).size.width * 0.02,
          bottom:  MediaQuery.of(context).size.width * 0.02),
      child: GestureDetector(
        ...
        child: Row(
          children: [
            Icon(Icons.reviews_outlined, color: AppColor.black,),
            SizedBox(
              width: MediaQuery.of(context).size.width * 0.03,
            ),
            TextWidget(AppString.reviewComplaint,
              fontSize: AppFont.font_12,
            ),
          ],
        ),
  ...
  Widget _viewEquipmentComplaint({required BuildContext context}) {
    return Padding(
      padding:  EdgeInsets.only(top: MediaQuery.of(context).size.width * 0.02,
          bottom:  MediaQuery.of(context).size.width * 0.02),
      child: GestureDetector(
        ...
        child: Row(
          children: [
            Icon(Icons.insights, color: AppColor.black,),
            SizedBox(
              width: MediaQuery.of(context).size.width * 0.03,
            ),
            TextWidget(AppString.viewEquipmentComplaint,
              fontSize: AppFont.font_12,
            ),
          ],
        ),
  ...
  Widget _miComplaint({required BuildContext context}) {
    return Padding(
      padding:  EdgeInsets.only(top: MediaQuery.of(context).size.width * 0.02,
          bottom:  MediaQuery.of(context).size.width * 0.02),
      child: GestureDetector(
        ...
        child: Row(
          children: [
            Icon(Icons.microwave_sharp, color: AppColor.black,),
            SizedBox(
              width: MediaQuery.of(context).size.width * 0.03,
            ),
            TextWidget(AppString.miComplaint,
              fontSize: AppFont.font_12,
            ),
          ],
        ),
