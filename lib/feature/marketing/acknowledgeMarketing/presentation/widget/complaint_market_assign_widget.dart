...
class ComplaintMarketAssignWidget extends StatefulWidget {
  ...
  @override
  State<ComplaintMarketAssignWidget> createState() => _ComplaintMarketAssignWidgetState();
}

class _ComplaintMarketAssignWidgetState extends State<ComplaintMarketAssignWidget> {
  @override
        ...
        ? ButtonWidget(
            ...
            onPressed: () {
              BlocProvider.of<AcknowledgeMarketBloc>(context).add(
                  AcknowledgeMarketUserSubmitEvent(
                      context: context,
