List<ComplaintMarketModel> complaintMarketListResponse(var json) {
  return List<ComplaintMarketModel>.from(
      json.map((x) => ComplaintMarketModel.fromJson(x)));
}

class ComplaintMarketModel {
  String? id;
  String? ticketNo;
  String? tokenNo;
  String? facilityId;
  ...
  // Only in new/unassigned response
  String? subcategoryName;
  String? cngStationName;
  dynamic autoVendorName;

  // Only in assigned response
  dynamic assignedVendorName;
  String? assignTo;
  String? assignType;

  ComplaintMarketModel(
      {this.id,
        this.ticketNo,
        this.tokenNo,
        this.facilityId,
  ...
  ComplaintMarketModel.fromJson(Map<String, dynamic> json) {
    id = json['id'] ?? "";
    ...
    autoVendorName = json['auto_vendor_name'] ?? "";
  ...
  Map<String, dynamic> toJson() {
    ...
    data['auto_vendor_name'] = autoVendorName;
