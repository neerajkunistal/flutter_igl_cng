...
class ViewAmoDetailPage extends StatefulWidget {
  const ViewAmoDetailPage({super.key});

  @override
  State<ViewAmoDetailPage> createState() => _ViewAmoDetailPageState();
}

class _ViewAmoDetailPageState extends State<ViewAmoDetailPage> {
