List<ReviewComplaintModel> reviewComplaintListResponse(var json) {
  return List<ReviewComplaintModel>.from(json.map((x) => ReviewComplaintModel.fromJson(x)));
}
...
class ReviewComplaintModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['mi_attach_file'] = this.miAttachFile;
    data['amc_status'] = this.amcStatus;
    data['amc_date'] = this.amcDate;
    data['remarks'] = this.remarks;
    data['start_date_time'] = this.startDateTime;
    data['close_date_time'] = this.closeDateTime;
    data['spare_id'] = this.spareId;
    data['se_approval'] = this.seApproval;
    data['se_observation'] = this.seObservation;
    return data;
  }
}