...
class _ReviewComaplintPageState extends State<ReviewComaplintPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: TextWidget("Review Complaint", color: AppColor.white,),
      ),
  ...
  Widget _complaintTypeDropDown({required FetchReviewComplaintDataState dataState}) {
  ...
  Widget _observationController({required FetchReviewComplaintDataState dataState}) {
          ...
          child: Column(
            children: [
              TextButton(onPressed: () {
                BlocProvider.of<ReviewComplaintBloc>(context).add(ReviewComplaintAddImageEvent(context: context, mediaType: 1));
              }, child: TextWidget("Camera", fontSize: AppFont.font_16,)),
              const Divider(),
              TextButton(onPressed: () {
                BlocProvider.of<ReviewComplaintBloc>(context).add(ReviewComplaintAddImageEvent(context: context, mediaType: 2));
  ...
  Widget _button({required FetchReviewComplaintDataState dataState}) {
    ...
    ButtonWidget(text: AppString.submit,
        ...
        onPressed: () {
          BlocProvider.of<ReviewComplaintBloc>(context).add(ReviewComplaintSubmitEvent(context: context));
        }
